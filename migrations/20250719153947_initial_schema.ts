...
export async function up(knex: Knex): Promise<void> {
  ...
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_patients_mrn ON patients(mrn);");
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_appointments_patient_date ON appointments(patient_id, appointment_date);");
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_appointments_doctor_date ON appointments(doctor_id, appointment_date);");
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_medical_records_patient ON medical_records(patient_id);");
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_vital_signs_patient_date ON vital_signs(patient_id, recorded_at);");
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_lab_results_patient ON lab_results(patient_id);");
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_prescriptions_patient ON prescriptions(patient_id);");
  await knex.schema.raw("CREATE INDEX IF NOT EXISTS idx_audit_logs_user_date ON audit_logs(user_id, created_at);");
}
