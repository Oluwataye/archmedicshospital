    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, knex.schema.alterTable("patients", function (table) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, knex.schema.raw("CREATE INDEX idx_patients_nhis_enrollment ON patients(nhis_enrollment_number);")];
                case 2:
                    // Create index for NHIS enrollment number lookups
                    _a.sent();
                    return [4 /*yield*/, knex.schema.raw("CREATE INDEX idx_patients_hmo_provider ON patients(hmo_provider_id);")];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, knex.schema.raw("CREATE INDEX idx_patients_policy_dates ON patients(policy_start_date, policy_end_date);")];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
