...
export async function up(knex: Knex): Promise<void> {
    // Create invoices table FIRST (no dependencies)
    ...
    // Create payments table SECOND (depends on invoices)
    ...
    // Create invoice_items table THIRD (depends on invoices)
    ...
    // Create refunds table LAST (depends on payments)
