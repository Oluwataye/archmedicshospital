...
var CriticalResultsPage = function () {
    ...
    var filteredResults = allCriticalResults.filter(function (result) {
        return searchQuery === '' ||
    ...
    var handleReportCriticalResult = function (testId) {
        sonner_1.toast.info("Reporting critical result for test ".concat(testId));
    };
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredResults.map(function (result) { return (<tr key={result.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {result.reportedTo ? (<span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {!result.reportedTo && (<button_1.Button variant="ghost" size="sm" className="text-red-600 hover:text-red-900 mr-2 p-0" onClick={function () { return handleReportCriticalResult(result.id); }}>
...
exports.default = CriticalResultsPage;
