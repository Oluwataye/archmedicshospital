...
var LabDashboard = function () {
    ...
    var stats = [
        { title: "Today's Tests", value: 24, icon: <lucide_react_1.FlaskConical className="h-5 w-5 text-blue-600"/>, color: 'bg-blue-100' },
        { title: "Pending Tests", value: 12, icon: <lucide_react_1.Clock className="h-5 w-5 text-yellow-600"/>, color: 'bg-yellow-100' },
        { title: "Completed Today", value: 10, icon: <lucide_react_1.CheckCircle className="h-5 w-5 text-green-600"/>, color: 'bg-green-100' },
        { title: "Critical Results", value: 2, icon: <lucide_react_1.AlertTriangle className="h-5 w-5 text-red-600"/>, color: 'bg-red-100' }
    ];
    ...
    var recentActivities = [
        {
            ...
            time: '10 minutes ago',
            icon: <lucide_react_1.FlaskConical className="h-4 w-4 text-blue-600"/>,
            iconBg: 'bg-blue-100'
        },
        {
            id: 2,
            ...
            time: '25 minutes ago',
            icon: <lucide_react_1.AlertTriangle className="h-4 w-4 text-red-600"/>,
            iconBg: 'bg-red-100'
        },
        {
            id: 3,
            ...
            time: '1 hour ago',
            icon: <lucide_react_1.CheckCircle className="h-4 w-4 text-green-600"/>,
            iconBg: 'bg-green-100'
        }
    ];
    ...
    return (<div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        {stats.map(function (stat, index) { return (<card_1.Card key={index} className="border border-gray-200">
            <card_1.CardContent className="p-4">
              <div className="flex items-center">
                <div className={"w-12 h-12 ".concat(stat.color, " rounded-full flex items-center justify-center mr-3")}>
                  {stat.icon}
                </div>
                <div>
      ...
      <card_1.Card className="border border-gray-200 mb-6">
        ...
        <div className="flex border-b border-gray-200">
          ...
          <div className="px-4 py-3 text-gray-500 cursor-pointer" onClick={function () { return navigate('/lab/results/completed'); }}>
            Completed Tests
          </div>
          <div className="px-4 py-3 text-gray-500 cursor-pointer" onClick={function () { return navigate('/lab/results/critical'); }}>
            Critical Results
          </div>
        ...
        <div className="p-4">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {testRequests.map(function (request) { return (<tr key={request.id}>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className="flex space-x-2">
              <button_1.Button variant="outline" size="sm" className="text-sm">Previous</button_1.Button>
              <button_1.Button variant="default" size="sm" className="text-sm bg-blue-500">1</button_1.Button>
              <button_1.Button variant="outline" size="sm" className="text-sm">2</button_1.Button>
              <button_1.Button variant="outline" size="sm" className="text-sm">3</button_1.Button>
              <button_1.Button variant="outline" size="sm" className="text-sm">Next</button_1.Button>
            </div>
          </div>
        </div>
      </card_1.Card>
      ...
      <card_1.Card className="border border-gray-200 mb-6">
        <card_1.CardContent className="p-4">
          ...
          <div className="space-y-4">
            {recentActivities.map(function (activity) { return (<div key={activity.id} className="flex items-start">
                <div className={"w-8 h-8 ".concat(activity.iconBg, " rounded-full flex items-center justify-center mr-3 mt-1")}>
                  {activity.icon}
                </div>
                <div>
      ...
      <button_1.Button className="fixed bottom-8 right-8 w-14 h-14 rounded-full shadow-lg" style={{ backgroundColor: '#3B82F6' }}>
        <span className="text-xl font-bold">+</span>
      </button_1.Button>
    </div>);
};
exports.default = LabDashboard;
