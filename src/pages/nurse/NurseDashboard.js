...
exports.default = NurseDashboard;
...
function NurseDashboard() {
    ...
    var _a = (0, react_1.useState)({
        ...
        emergency: false,
        communication: false
    }), expandedMenus = _a[0], setExpandedMenus = _a[1];
    ...
    return (<div className="flex h-screen bg-gray-50">
      ...
      <div className="w-56 bg-gray-800 text-white flex flex-col">
        ...
        <nav className="flex-1 overflow-y-auto">
          ...
          {/* Patients (Expandable) */}
          <div className="bg-gray-700 py-3 px-4 flex items-center justify-between cursor-pointer" onClick={function () { return toggleMenu('patients'); }}>
            ...
            {expandedMenus.patients ? <lucide_react_1.ChevronDown size={16}/> : <lucide_react_1.ChevronRight size={16}/>}
          </div>
          ...
          <div className="bg-gray-700 py-3 px-4 flex items-center justify-between cursor-pointer" onClick={function () { return toggleMenu('medication'); }}>
            <div className="flex items-center">
              <div className="w-8 h-8 flex items-center justify-center border border-white rounded-full mr-3">
            ...
            {expandedMenus.medication ? <lucide_react_1.ChevronDown size={16}/> : <lucide_react_1.ChevronRight size={16}/>}
          </div>
          ...
          <div className="bg-gray-700 py-3 px-4 flex items-center justify-between cursor-pointer" onClick={function () { return toggleMenu('vitalSigns'); }}>
            <div className="flex items-center">
              <div className="w-8 h-8 flex items-center justify-center border border-white rounded-full mr-3">
                <svg className="w-4 h-4" fill="none" stroke="white" viewBox="0 0 24 24">
            ...
            {expandedMenus.vitalSigns ? <lucide_react_1.ChevronDown size={16}/> : <lucide_react_1.ChevronRight size={16}/>}
          </div>
          ...
          <div className="bg-gray-700 py-3 px-4 flex items-center justify-between cursor-pointer" onClick={function () { return toggleMenu('tasks'); }}>
            <div className="flex items-center">
              <div className="w-8 h-8 flex items-center justify-center border border-white rounded-full mr-3">
                <svg className="w-4 h-4" fill="none" stroke="white" viewBox="0 0 24 24">
            ...
            {expandedMenus.tasks ? <lucide_react_1.ChevronDown size={16}/> : <lucide_react_1.ChevronRight size={16}/>}
          </div>

          {/* Wards & Rooms (Expandable) */}
          <div className="bg-gray-700 py-3 px-4 flex items-center justify-between cursor-pointer" onClick={function () { return toggleMenu('wards'); }}>
            <div className="flex items-center">
              <div className="w-8 h-8 flex items-center justify-center border border-white rounded-full mr-3">
                <svg className="w-4 h-4" fill="none" stroke="white" viewBox="0 0 24 24">
            ...
            {expandedMenus.wards ? <lucide_react_1.ChevronDown size={16}/> : <lucide_react_1.ChevronRight size={16}/>}
          </div>

          {/* Emergency Alerts (Expandable) */}
          <div className="bg-gray-700 py-3 px-4 flex items-center justify-between cursor-pointer" onClick={function () { return toggleMenu('emergency'); }}>
            <div className="flex items-center">
              <div className="w-8 h-8 flex items-center justify-center border border-white rounded-full mr-3">
            ...
            {expandedMenus.emergency ? <lucide_react_1.ChevronDown size={16}/> : <lucide_react_1.ChevronRight size={16}/>}
          </div>

          {/* Communication (Expandable) */}
          <div className="bg-gray-700 py-3 px-4 flex items-center justify-between cursor-pointer" onClick={function () { return toggleMenu('communication'); }}>
            <div className="flex items-center">
              <div className="w-8 h-8 flex items-center justify-center border border-white rounded-full mr-3">
                <svg className="w-4 h-4" fill="none" stroke="white" viewBox="0 0 24 24">
            ...
            {expandedMenus.communication ? <lucide_react_1.ChevronDown size={16}/> : <lucide_react_1.ChevronRight size={16}/>}
          </div>
        ...
        <div className="bg-red-500 py-2 px-4 flex items-center cursor-pointer hover:bg-red-600" onClick={logout}>
          <lucide_react_1.LogOut className="w-4 h-4 mr-3"/>
          <span>Logout</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="h-16 bg-white border-b border-gray-200 flex items-center px-6 justify-between">
          ...
          <div className="relative">
            ...
            <input type="text" placeholder="Search patients, tasks or alerts..." className="bg-gray-100 pl-10 pr-4 py-2 rounded border border-gray-300 w-64"/>
          </div>

          <div className="flex items-center space-x-4">
            {/* Notifications */}
            <div className="relative cursor-pointer">
              <lucide_react_1.Bell className="h-6 w-6 text-gray-500"/>
              ...
              <div className="p-4 flex">
                ...
                <div className="relative w-32 h-32">
                  <svg viewBox="0 0 100 100" className="w-full h-full">
                    ...
                    <path d="M50,50 L50,5 A45,45 0 0,1 95,50 Z" fill="#3498db"/>
                    <path d="M50,50 L95,50 A45,45 0 0,1 50,95 Z" fill="#e74c3c"/>
                    <path d="M50,50 L50,95 A45,45 0 0,1 5,50 Z" fill="#2ecc71"/>
                    <path d="M50,50 L5,50 A45,45 0 0,1 50,5 Z" fill="#e0e0e0"/>
                  </svg>
                </div>
